                ...
                <div class="card-header">
                	<div class="row">
                		...
                		<div class="col-md-3 text-end">
                			<button type="button" name="add" id="addBrand" class="btn btn-primary bg-gradient btn-sm rounded-0"><i class="far fa-plus-square"></i> Yeni marka</button>
                		</div>
                	</div>
                </div>
                <div class="card-body">
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
    					...
    					<input type="hidden" name="btn_action" id="btn_action" />
							...
							<div class="mb-3">
								<label>Marka Adını Girininiz</label>
    				...
    				<div class="modal-footer">
    					...
    					<button type="button" class="btn btn-default btn-sm rounded-0" data-bs-dismiss="modal">Kapat</button>
    				</div>
    			</div>
    	</div>
    </div>
