...
<?php include('inc/container.php');?>
	...
	<h1 class="text-center my-4 py-3 text-light" id="title">Stok Yönetim Sistemi</h1>	
	<div class="col-lg-4 col-md-5 col-sm-10 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-header">
				<div class="card-title h3 text-center mb-0 fw-bold">Giriş yapmak</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
					<form method="post" action="">
						...
						<div class="d-grid">
							<button type="submit" name="login" class="btn btn-primary rounded-0">Giriş yap</button>
						</div>
					</form>
				</div>
			</div>
